...
feat_models = {n: models.Model(inputs=model_scratch.inputs,
...
def make_gradcam(model, img_array, last_conv_name):
    # ambil base MobileNetV2
    base_model = model.get_layer("mobilenetv2_1.00_96")
    # ambil layer conv terakhir dari base model
